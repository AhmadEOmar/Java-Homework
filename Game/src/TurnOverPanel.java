...
public class TurnOverPanel extends JPanel {
	...
	private void makeNorth() {
		...
		titleLabel = new JLabel("NFL Turnover Differential Analyzer");
	...
	private void makeWest(){
		...
		leftLeft = new JPanel();
		leftLeft.setLayout(new GridLayout(1,2));
		
		
		JButton lAddButton = new JButton("ADD");
		JButton lMinusButton = new JButton("SUBTRACT");
	...
	private void makeEast(){
		...
		JButton rMinusButton = new JButton("SUBTRACT");
